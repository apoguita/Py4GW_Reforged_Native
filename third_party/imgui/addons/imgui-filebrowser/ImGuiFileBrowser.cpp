...
namespace imgui_addons
{
    ...
    bool ImGuiFileBrowser::showFileDialog(const std::string& label, const DialogMode mode, const ImVec2& sz_xy, const std::string& valid_types)
    {
        ...
        const bool popup_visible = use_modal
            ? ImGui::BeginPopupModal(label.c_str(), nullptr, window_flags)
            : ImGui::BeginPopup(label.c_str(), window_flags);
    ...
    bool ImGuiFileBrowser::renderNavAndSearchBarRegion()
    {
        ...
        ImGui::BeginChild("##NavigationWindow", nw_size, ImGuiChildFlags_Borders |
														 ImGuiChildFlags_AutoResizeX |
														 ImGuiChildFlags_AutoResizeY |
														 ImGuiChildFlags_AlwaysAutoResize, ImGuiWindowFlags_NoScrollbar);
        ...
        ImGui::SameLine();
        ImGui::BeginChild("##SearchWindow", sw_size, ImGuiChildFlags_Borders |
													 ImGuiChildFlags_AutoResizeX |
													 ImGuiChildFlags_AutoResizeY |
													 ImGuiChildFlags_AlwaysAutoResize, ImGuiWindowFlags_NoScrollbar);
    ...
    bool ImGuiFileBrowser::renderFileListRegion()
    {
        ...
        ImGui::BeginChild("##ScrollingRegion", ImVec2(0, window_height), ImGuiChildFlags_Borders, ImGuiWindowFlags_HorizontalScrollbar);
    ...
    bool ImGuiFileBrowser::renderInputComboBox()
    {
        ...
        if(show_inputbar_combobox && ( ImGui::GetCurrentFocusScope() == focus_scope_id || ImGui::GetCurrentContext()->ActiveIdIsAlive == input_id  ))
        {
            ...
            ImGui::BeginChild("##InputBarComboBox", input_combobox_sz, ImGuiChildFlags_Borders, popupFlags);
    ...
    void ImGuiFileBrowser::showInvalidFileModal()
    {
        ...
        if (ImGui::BeginPopupModal(invfile_modal_id.c_str(), nullptr, ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoResize))
        {
            ...
            if(valid_exts.back() != "*.*")
            {
                ...
                ImGui::BeginChild("##SupportedExts", ImVec2(0, cw_height), ImGuiChildFlags_Borders);
